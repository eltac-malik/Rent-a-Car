    ...
    return (
        <div className='navbar'>
            ...
            <i onClick={handleSideClose} className="fa-solid fa-2x fa-xmark"></i>
                ...
                <p className='for-p'><Link onClick={autoClose} className='link for-p' to='/home'>Home</Link></p>
                <p className='for-p'><Link onClick={autoClose} className='link for-p' to='/cars'>Cars</Link></p>
                <p className='for-p'><Link onClick={autoClose} className='link for-p' to='/home'>Online Booking</Link></p>
                <p className='for-p'><Link onClick={autoClose} className='link for-p' to='/home'>About</Link></p>
                <p className='for-p'><Link onClick={autoClose} className='link for-p' to='/home'>Contact Us</Link></p>
            </div>
            <div className="img">
